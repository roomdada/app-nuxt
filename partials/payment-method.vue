...
<template>
  <div>
    <div class="px-6 py-6 rounded-md shadow-lg mb-4">
      <div class="flex justify-between mb-4">
        <div class="space-y-1">
          <h3 class="text-xl leading-6 font-medium text-gray-900">Listes des differents moyens de paiement</h3>
        </div>
      ...
      <div class='container mb-4'>
        ...
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr>
              <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Wave CI</td>

              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                <img class="h-24 w-24 rounded-full object-cover"
                  src="https://africabusinesscommunities.com/Images/Key%20Logos/wave.png" alt="">
              </td>
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
  ...
  <div class="modal">
    <div class="modal-box">
      <h3 class="font-bold text-xl mb-4">Ajouter un nouveau moyen de paiement</h3>
      <form class="mx-auto">
        <div class="grid grid-cols-8">
          <div class="col-span-12 md:col-span-12">
            ...
            <div class="form-control">
              ...
              <input type="file" placeholder="" class="input input-bordered w-full max-w-full" />
            </div>
          </div>
        </div>
      </form>
  ...
  <div class="modal">
    <div class="modal-box">
      <h3 class="font-bold text-xl mb-4">Editer le moyen de paiement</h3>
      <form class="mx-auto">
        <div class="grid grid-cols-8">
          <div class="col-span-12 md:col-span-12">
            <div class="form-control">
    ...
    <div class="modal-box">
      ...
      <div class="sm:flex sm:items-start">
        ...
        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
          <h3 class="text-lg font-medium leading-6 text-gray-900" id="modal-title">Suppression du moyen de paiement</h3>
          <div class="mt-2">
            <p class="text-sm text-gray-500">Etes-vous sur de vouloir supprimer cet moyen de paiement ?</p>
          </div>
        </div>
      </div>
      <div class="modal-action">
