...
<template>
  ...
  <thead class="bg-blue-500 rounded-t-lg">
    <tr>
      <th scope="col"
        class="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Libellé</th>
      <th scope="col"
  ...
  <tbody class="bg-white divide-y divide-gray-200">
    <tr>
      <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Residences studio</td>
