...
<template>
  <table class="min-w-full divide-y divide-gray-200">
    <thead class="bg-blue-500 rounded-t-lg">
      <tr>
        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Nom
        </th>
        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Abreviation
        </th>
        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Nbr de
          fichier
        </th>
    ...
    <tbody class="bg-white divide-y divide-gray-200 dark:divide-none">
      <tr>
        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Attestation</td>
        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">ATT55</td>
