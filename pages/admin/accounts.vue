    ...
    <div class="bg-white shadow">
                  ...
                  <div>
                    <div class="flex items-center">
                      <img class="h-16 w-16 rounded-full sm:hidden"
                        src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2.6&w=256&h=256&q=80"
                        alt="">
                      <h1 class="ml-3 text-2xl font-bold leading-7 text-gray-900 sm:leading-9 sm:truncate">Bonjour,
                        Konan
                        Romaric</h1>
                    </div>
                    <dl class="mt-6 flex flex-col sm:ml-3 sm:mt-1 sm:flex-row sm:flex-wrap">
                      ...
                      <dd class="flex items-center text-sm text-gray-500 font-medium capitalize sm:mr-6">
                        ...
                        Connecté en tant que proprietaire
                      </dd>
        ...
        <div class="mt-8">
          <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-3xl leading-6 font-medium text-gray-900">Tableau de bord</h2>
            <div class="mt-2 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div class="bg-white overflow-hidden shadow rounded-lg">
                <div class="p-5">
                  <div class="flex items-center">
                    <div class="flex-shrink-0 border-2 px-4 py-4 rounded-lg border-blue-700">
                ...
                <div class="bg-gray-50 px-5 py-3">
                  <div class="text-sm">
                    <a href="/owner-users" class="font-medium text-cyan-700 hover:text-cyan-900"> Consulter </a>
                  </div>
                </div>
              </div>
              <div class="bg-white overflow-hidden shadow rounded-lg">
                ...
                <div class="bg-gray-50 px-5 py-3">
                  <div class="text-sm">
                    <a href="/bookings" class="font-medium text-cyan-700 hover:text-cyan-900"> Consulter </a>
                  </div>
                </div>
              </div>
              <div class="bg-white overflow-hidden shadow rounded-lg">
                  ...
                  <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                      <dl>
                        ...
                        <dd>
                          <div class="text-lg font-medium text-gray-900">12500</div>
                        </dd>
                      </dl>
                    </div>
                  </div>
                ...
                <div class="bg-gray-50 px-5 py-3">
                  <div class="text-sm">
                    <a href="/residences" class="font-medium text-cyan-700 hover:text-cyan-900"> Consulter </a>
                  </div>
                </div>
              </div>
          ...
          <h2 class="max-w-6xl mx-auto mt-8 px-4 text-lg leading-6 font-medium text-gray-900 sm:px-6 lg:px-8">Google Map
          </h2>
